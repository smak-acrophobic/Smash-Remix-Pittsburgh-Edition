...
scope Toggles {
    ...
    entry_1v1_combo_meter_swap:;        entry_bool("1v1 Combo Meter Swap", OS.TRUE, OS.FALSE, OS.FALSE, OS.FALSE, entry_neutral_spawns)
    ...
    entry_l_random_char:;               entry_bool("'L' Selects Random Character", OS.TRUE, OS.FALSE, OS.FALSE, OS.FALSE, entry_dpad_css_control)
    ...
    entry_menu_music:;                      entry("Menu Music", Menu.type.INT, 20, 0, 1, 0, 0, menu_music.MAX_VALUE, play_menu_music_, string_table_menu_music, OS.NULL, entry_show_music_title)
    ...
    // Stage Toggles
    head_stage_settings:
    entry_sss_layout:;                          entry("Stage Select Layout", Menu.type.INT, sss.TOURNAMENT, sss.TOURNAMENT, sss.NORMAL, sss.NORMAL, 0, 1, OS.NULL, string_table_sss_layout, OS.NULL, entry_hazard_mode)
    ...
    entry_announcer_mode:;                      entry("Pokemon Announcer", Menu.type.INT, announcer_mode.OFF, announcer_mode.OFF, announcer_mode.POKEMON, announcer_mode.OFF, 0, 2, OS.NULL, string_table_announcer_mode, OS.NULL, entry_dragon_king_hud)
    ...
    entry_load_profile_stage:;                  entry("Load Profile:", Menu.type.INT, 1, 1, 2, 0, 0, 2, load_sub_profile_, num_toggles, string_table_stage_profile, OS.NULL, entry_random_stage_title)
    ...
    entry_random_stage_congo_jungle:;           entry_bool("Congo Jungle", OS.FALSE, OS.FALSE, OS.TRUE, OS.TRUE, entry_random_stage_dream_land)
    ...
    entry_random_stage_duel_zone:;              entry_bool("Duel Zone", OS.FALSE, OS.FALSE, OS.FALSE, OS.TRUE, entry_random_stage_final_destination)
    entry_random_stage_final_destination:;      entry_bool("Final Destination", OS.FALSE, OS.FALSE, OS.FALSE, OS.TRUE, entry_random_stage_how_to_play)
    ...
    entry_random_stage_hyrule_castle:;          entry_bool("Hyrule Castle", OS.FALSE, OS.FALSE, OS.TRUE, OS.TRUE, entry_random_stage_meta_crystal)
    entry_random_stage_meta_crystal:;           entry_bool("Meta Crystal", OS.FALSE, OS.FALSE, OS.TRUE, OS.TRUE, entry_random_stage_mushroom_kingdom)
    entry_random_stage_mushroom_kingdom:;       entry_bool("Mushroom Kingdom", OS.FALSE, OS.FALSE, OS.FALSE, OS.TRUE, entry_random_stage_peachs_castle)
    entry_random_stage_peachs_castle:;          entry_bool("Peach's Castle", OS.FALSE, OS.FALSE, OS.TRUE, OS.TRUE, entry_random_stage_planet_zebes)
    entry_random_stage_planet_zebes:;           entry_bool("Planet Zebes", OS.FALSE, OS.FALSE, OS.FALSE, OS.TRUE, entry_random_stage_saffron_city)
    entry_random_stage_saffron_city:;           entry_bool("Saffron City", OS.FALSE, OS.FALSE, OS.TRUE, OS.TRUE, entry_random_stage_sector_z)
    entry_random_stage_sector_z:;               entry_bool("Sector Z", OS.FALSE, OS.FALSE, OS.FALSE, OS.TRUE, entry_random_stage_yoshis_island)
    entry_random_stage_yoshis_island:;          entry_bool("Yoshi's Island", OS.FALSE, OS.FALSE, OS.FALSE, OS.TRUE, entry_random_stage_mini_yoshis_island)
    entry_random_stage_mini_yoshis_island:;     entry_bool("Mini Yoshi's Island", OS.FALSE, OS.FALSE, OS.TRUE, OS.TRUE, entry_random_stage_first_custom)
